...
export default function FindTutor({ setSection }) {
    ...
    return (
        <div className="w-full h-full flex justify-center z-40 items-center min-h-0">
            <div className="h-11/12 w-11/12 relative">
                <div className='h-10 w-full bg-gradient-to-t from-white to-transparent z-20 opacity-90 absolute bottom-0 rounded-4xl pointer-events-none'></div>

                <div className="flex justify-start items-center h-full w-full overflow-y-scroll flex-col bg-[rgba(255,255,255,0.75)] rounded-3xl shadow-lg font-roboto py-2">
                    {!subject && loaded &&
