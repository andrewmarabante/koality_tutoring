                    ...
                    <div className="flex flex-col justify-start items-center w-full overflow-hidden">
                        ...
                        <div className="overflow-scroll">
                            {chats && chats.map(chat => {
                                ...
                                const formattedDate = lastMessageDate.toLocaleTimeString([], {
                                hour: 'numeric',
                                minute: '2-digit',
                                hour12: true
                                });
                                console.log('current: ', currentUser)
                                console.log('filtered: ', otherUsers)
                                return(
                                    <div className="flex items-center justify-start gap-2 w-full px-5 py-2 relative mb-3">
